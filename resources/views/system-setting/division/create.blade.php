              ...
              <div class="col-sm-12">
                <div class="card">
                  <div class="card-header pb-0 card-no-border d-flex justify-content-between align-items-center">
                    <h5>Division</h5>
                    <a href="{{ baseUrl('setting/division') }}"  class="btn btn-primary btn-md">
                                View 
                    </a>
                  </div>
                  <div class="card-body">
                  <form wire:submit="{{($id)?'update':'save'}}" class="row g-3 needs-validation custom-input" novalidate="">
                      <div class="col-12">
                        <x-input-label for="division_name" :value="__('Division Name')" />
                        <x-text-input wire:model="division_name" id="division_name" class="form-control" type="text" required autofocus />
