<div class="card">
                  <div class="card-header pb-0 card-no-border d-flex justify-content-between align-items-center">
                    ...
                    <a href="{{ baseUrl('workspace/add') }}"  class="btn btn-primary btn-md">
                                Add 
                    </a>
                  </div>
                  <div class="card-body">
                    ...
                    <table dataTable class="dt-responsive">
                        ...
                        <tr>
                            ...
                            <td>{{ $value->workspace_email }}</td>
                            <td>{{ $value->workspace_phone_number }}</td>
                            <td>{{ ($value->workspace_status==1)?'Active': 'Inactive' }}</td>
                            <td>
